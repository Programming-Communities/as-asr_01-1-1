      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-6 border-b border-gray-800">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            Your trusted platform for Islamic knowledge, community programs, and spiritual guidance.
          </p>
        </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {quickLinks.map((link) => (
                    <Link
                      key={link.name}
                      href={link.href}
                      className="flex items-center gap-2 p-2 text-gray-300 hover:text-red-400 transition-colors rounded-lg hover:bg-gray-800"
                    >
                      <span>{link.icon}</span>
        ...
        <div className="py-6 border-t border-gray-800">
          <h4 className="font-semibold text-white mb-4 text-center">Stay Connected</h4>
          ...
          <div className="flex justify-center gap-3 mb-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-300 hover:bg-red-500 hover:text-white transition-all duration-300"
          ...
          <div className="text-center">
            <p className="text-gray-300 text-sm mb-3">Get updates</p>
