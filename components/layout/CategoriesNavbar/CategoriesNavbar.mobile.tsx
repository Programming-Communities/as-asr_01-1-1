...
export default function CategoriesNavbarMobile() {
  ...
  return (
    <div className="flex overflow-x-auto gap-2 py-3 px-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 scrollbar-hide">
      <Link
        href="/"
